...
------PROCEDURA PARA MOSTRAR LAS RUTAS FRECUENTES EN EL DROP DOWN
CREATE PROCEDURE CONSULTA_RUTA
AS

begin 
SELECT IDRUTA,RUTA FROM RUTAS

end
GO

------ PROCEDURE PARA MOSTRAR LOS CONDUCTORES EN EL DROP DOWN
CREATE PROCEDURE CONSULTA_CONDUCTOR
AS

begin
SELECT ID,PLACA FROM CONDUCTOR
